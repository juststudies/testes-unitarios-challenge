...
import { TransfersOperationController } from '../modules/statements/useCases/transfersOperation/TransfersOperationController';
...
const transfersOperationController = new TransfersOperationController();
...
statementRouter.post('/transfers/:user_id', transfersOperationController.handle);
